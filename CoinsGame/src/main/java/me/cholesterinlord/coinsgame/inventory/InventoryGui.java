...
public class InventoryGui {
    ...
    private EventListener<InventoryClickEvent> clickListener;
    private EventListener<InventoryCloseEvent> closeListener;

    public InventoryGui(CoinsGame plugin, GuiItem[] guiItems, String name, Inventory inventory, Consumer<Player> closeConsumer) {
        this.plugin = plugin;
